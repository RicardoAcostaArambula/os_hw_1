...
manipulation calls, like fopen, fread, fprintf etc, not even for error messages. In case of an error, display An error occured while xxx: yyy1 on standard error which just a call to write. Write your own
